        ...
        $todos = Todo::where('user_id', Auth::id())
            ->where(function ($q) use ($query) {
                $q->where('title', 'like', '%' . $query . '%')
                    // Atau mencari berdasarkan judul kategori (melalui relasi 'category')
                    ->orWhereHas('category', function ($Q) use ($query) {
                        $Q->where('title', 'like', '%' . $query . '%')
                          ->where('user_id', Auth::id()); // Pastikan kategori juga milik user yang sama
                    });
            })
            ->with('category') // Memuat relasi 'category'
            ->get();
